...
inline constexpr std::ptrdiff_t kActorRotationComponentPtrOffset = 0x218;
...
inline constexpr std::ptrdiff_t kItemThrowTimeOffset = 0x430;
inline constexpr std::ptrdiff_t kItemBobOffset = 0x434;
inline constexpr std::ptrdiff_t kIsInItemFrameOffset = 0x440;
inline constexpr std::ptrdiff_t kItemRenderAdjustmentsOffset = 0x444;
inline constexpr std::ptrdiff_t kItemFirstRenderedYawOffset = 0x448;
inline constexpr std::ptrdiff_t kItemRenderAdjustmentsEngagedOffset = 0x44C;
...
inline constexpr std::array<std::uint32_t,3> kGetPosDeltaFingerprint={0xF9410408u,0x91006100u,0xD65F03C0u};
...
inline constexpr std::array<std::uint32_t,7> kGetBlockTypeForRenderingFingerprint={
0xF9400408u,0xB40000C8u,0xF9400100u,0xB4000080u,
0xF9400008u,0xF9401D01u,0xD61F0020u};
inline constexpr std::array<std::uint32_t,5> kBlockGraphicsGetForBlockTypeFingerprint={
0xA9BF7BFDu,0x910003FDu,0x9556EC78u,0xA8C17BFDu,0x17FFFFA1u};
inline constexpr std::array<std::uint32_t,2> kBlockGraphicsGetBlockShapeFingerprint={0xB9401000u,0xD65F03C0u};
...
inline constexpr std::array<std::uint32_t,12> kRelativeShadowStorageFingerprint={
...
inline constexpr std::array<std::uint32_t,12> kRelativeShadowEmplaceFingerprint={
