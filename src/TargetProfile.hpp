...
inline constexpr std::uintptr_t kGetBlockTypeForRenderingRva =
    0x0F642ADC;

inline constexpr std::uintptr_t kBlockGraphicsGetForBlockTypeRva =
    0x0A2189DC;
...
inline constexpr std::uintptr_t kItemRendererRenderHelperRva =
    0x0A29EC90;

inline constexpr std::uint32_t kOnGroundFlagComponentHash =
    0xC29078A0u;

inline constexpr std::uint32_t kActorRotationComponentHash =
    0x75DF36B7u;

inline constexpr std::uint32_t kRelativeShadowOffsetComponentHash =
    0x7FD7A655u;

inline constexpr std::uintptr_t kRelativeShadowStorageRva =
    0x0E96A7E4;

inline constexpr std::uintptr_t kRelativeShadowEmplaceRva =
    0x0E96B68C;

inline constexpr std::array<std::uint32_t,24>
kRenderFingerprint = {
