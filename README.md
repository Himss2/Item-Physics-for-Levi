...
Version `0.8.2` keeps the universal Java ItemPhysic `1.8.15` animation while
correcting the remaining Bedrock ground, stack, head, and spawn-path cases.
...
- Full 3D blocks keep the exact contact angle. Thin structural models such as
  fences, ladders, bars, and panes use the flat contact pose only after landing.
- Ground offsets are tuned independently for flat, thin, shaped, head, special,
  ...
  tilt-dependent support clearance; Dragon Head retains extra jaw clearance.
